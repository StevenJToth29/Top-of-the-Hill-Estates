...
describe('PATCH /api/admin/bookings/[id]/edit', () => {
  ...
  it('creates Checkout Session and queues email when new total is higher', async () => {
  ...
  it('recalculates long_term total based only on guest_count change', async () => {
    ...
    // Changing from 2 guests to 3 guests: extraGuests = max(0, 3-1) = 2
    // new total = 3000 + 500 + 100*2 = 3700
