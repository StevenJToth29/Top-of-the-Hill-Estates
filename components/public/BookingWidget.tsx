...
export default function BookingWidget({ room, blockedDates }: Props) {
  ...
  return (
    <div className="bg-surface-highest/40 backdrop-blur-xl shadow-[0_8px_40px_rgba(175,201,234,0.06)] rounded-2xl p-5 space-y-5 sticky top-6">
      ...
      <button
        onClick={handleBook}
        className="w-full bg-gradient-to-r from-primary to-secondary text-background font-display font-semibold py-3 rounded-2xl shadow-[0_0_10px_rgba(175,201,234,0.30)] hover:opacity-90 transition-opacity"
      >
        Book Now
      </button>
    </div>
